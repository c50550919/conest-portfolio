...
describe('Matching Algorithm', () => {
    ...
    beforeEach(async () => {
        ...
        const user1 = await (0, supertest_1.default)(server_1.default)
        ...
        const user2 = await (0, supertest_1.default)(server_1.default)
            .post('/api/auth/register')
            .send({
        ...
        const user3 = await (0, supertest_1.default)(server_1.default)
            .post('/api/auth/register')
            .send({
        ...
        const profile1 = await (0, supertest_1.default)(server_1.default)
            .post('/api/profiles')
        ...
        const profile2 = await (0, supertest_1.default)(server_1.default)
            .post('/api/profiles')
        ...
        const profile3 = await (0, supertest_1.default)(server_1.default)
            .post('/api/profiles')
    ...
    describe('GET /api/matches/potential', () => {
        it('should return potential matches sorted by compatibility', async () => {
            ...
            for (let i = 0; i < response.body.length - 1; i++) {
                expect(response.body[i].compatibility_score).toBeGreaterThanOrEqual(response.body[i + 1].compatibility_score);
            }
        });
        ...
        it('should calculate lower compatibility for different locations', async () => {
            ...
            const matchWithUser3 = response.body.find((m) => m.profile_id === profile3Id);
            if (matchWithUser3) {
    ...
    describe('DELETE /api/matches/:id', () => {
        let matchId;
        beforeEach(async () => {
            const match = await (0, supertest_1.default)(server_1.default)
                .post('/api/matches/interest')
                .set('Authorization', `Bearer ${user1Token}`)
                .send({ profile_id: profile2Id });
        ...
        it('should remove match successfully', async () => {
            ...
            const response = await (0, supertest_1.default)(server_1.default)
                ...
                .set('Authorization', `Bearer ${user1Token}`)
                .expect(200);
            const deletedMatch = response.body.find((m) => m.id === matchId);
    ...
    describe('Safety and Privacy', () => {
        ...
        it('should require both users to express interest before revealing details', async () => {
            ...
            const response = await (0, supertest_1.default)(server_1.default)
                ...
                .set('Authorization', `Bearer ${user1Token}`)
                .expect(200);
            const oneWayMatch = response.body.find((m) => m.status === 'one_interested');
        ...
        it('should allow messaging only after mutual interest', async () => {
            ...
            const response = await (0, supertest_1.default)(server_1.default)
                ...
                .set('Authorization', `Bearer ${user1Token}`)
                .expect(200);
            const mutualMatch = response.body.find((m) => m.status === 'mutual_interest');
